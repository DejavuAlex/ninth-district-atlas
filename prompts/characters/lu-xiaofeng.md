...
> 用途：生成 陆晓峰 的人物形象图。生成后请命名为 `lu-xiaofeng.png` 放入 `public/portraits/`，前端会自动显示。

## 人物身份
港口博弈一方

## 性格与气质
谨慎、重利。心思缜密又重利、善于在港口博弈中提条件谈价码的利益方。

## 角色背景
陆晓峰在港口博弈中与各方周旋，是商路暗战里的一枚棋子。

## 世界观设定（务必体现）
灾变之后、持续数十年的“冰封期”极寒末世。全球大面积冰封，资源极度匮乏，旧文明只剩废墟，新秩序在壁垒、特区与帮派之间艰难重建。整体基调阴冷、潮湿、压抑，但仍有人间烟火与挣扎求生的温度。

## 外貌 · 神态 · 服装（按人物性格定制，彼此区分）
心思缜密又重利、善于在港口博弈中提条件谈价码的利益方。
