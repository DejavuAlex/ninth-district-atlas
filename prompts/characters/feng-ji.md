...
> 用途：生成 冯济 的人物形象图。生成后命名为 `冯济.png` 放入 `assets/人物/`，再运行 `npm run optimize:images` 自动转成 `public/portraits/feng-ji.webp`。

## 人物身份
后期政治对手

## 性格与气质
精明、摇摆、重利益。在后期局势中不断寻找自身处境和利益出口。

## 角色背景
冯济的选择多次影响八区、九区和最终战局，是秦禹后期必须处理的对手。
