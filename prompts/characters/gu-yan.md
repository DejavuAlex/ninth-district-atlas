...
> 用途：生成 顾言 的人物形象图。生成后命名为 `顾言.png` 放入 `assets/人物/`，再运行 `npm run optimize:images` 自动转成 `public/portraits/gu-yan.webp`。

## 人物身份
军政盟友

## 性格与气质
有背景、果断、讲合作。名字本身就有分量，背后牵动更大的资源。

## 角色背景
顾言在秦禹进入军政层面后成为重要盟友，影响长吉、八区和后期战局。
