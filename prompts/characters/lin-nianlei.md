...
> 用途：生成 林念蕾 的人物形象图。生成后命名为 `林念蕾.png` 放入 `assets/人物/`，再运行 `npm run optimize:images` 自动转成 `public/portraits/lin-nianlei.webp`。

## 人物身份
秦禹情感线重要人物

## 性格与气质
清醒、温柔、有主见。她把秦禹从战争和权谋中拉回私人情感。

## 角色背景
林念蕾在中后期与秦禹关系加深，是乱世中少数稳定的情感牵引。
