...
> 用途：生成 江小龙 的人物形象图。生成后请命名为 `jiang-xiaolong.png` 放入 `public/portraits/`，前端会自动显示。

## 人物身份
四区外援

## 性格与气质
仗义、果敢。远在四区、为人仗义，在秦禹受困海外时关键时刻出手相助的朋友。

## 角色背景
江小龙在秦禹海外受困时出手相助，是异地战线上的一份助力。

## 世界观设定（务必体现）
灾变之后、持续数十年的“冰封期”极寒末世。全球大面积冰封，资源极度匮乏，旧文明只剩废墟，新秩序在壁垒、特区与帮派之间艰难重建。整体基调阴冷、潮湿、压抑，但仍有人间烟火与挣扎求生的温度。

## 外貌 · 神态 · 服装（按人物性格定制，彼此区分）
远在四区、为人仗义，在秦禹受困海外时关键时刻出手相助的朋友。
