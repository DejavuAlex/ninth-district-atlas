...
> 用途：生成 历战 的人物形象图。生成后命名为 `历战.png` 放入 `assets/人物/`，再运行 `npm run optimize:images` 自动转成 `public/portraits/li-zhan.webp`。

## 人物身份
战场尖刀

## 性格与气质
勇猛、直接、抗压。能打硬仗、敢接高危任务的军事骨干。

## 角色背景
历战从中期行动到最终战场不断承担高风险任务，是秦禹阵营的锋刃。
