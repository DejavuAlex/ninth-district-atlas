...
> 用途：生成 项择昊 的人物形象图。生成后命名为 `项择昊.png` 放入 `assets/人物/`，再运行 `npm run optimize:images` 自动转成 `public/portraits/xiang-zehao.webp`。

## 人物身份
川府军事政治人物

## 性格与气质
坚定、有担当。在川府和最终战局中承担重要军事角色。

## 角色背景
项择昊从面见秦禹到最终请战，体现川府系内部的担当和战场选择。
