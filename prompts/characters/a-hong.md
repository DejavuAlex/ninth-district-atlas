...
> 用途：生成 阿宏 的人物形象图。生成后请命名为 `a-hong.png` 放入 `public/portraits/`，前端会自动显示。

## 人物身份
交易线断后者

## 性格与气质
仗义、硬气。性子仗义的底层硬汉，在一次逃亡中主动为同伴断后，最终惨死。

## 角色背景
阿宏之死是乱世吞噬底层的缩影，也让秦禹与吴天胤的线更显沉重。

## 世界观设定（务必体现）
灾变之后、持续数十年的“冰封期”极寒末世。全球大面积冰封，资源极度匮乏，旧文明只剩废墟，新秩序在壁垒、特区与帮派之间艰难重建。整体基调阴冷、潮湿、压抑，但仍有人间烟火与挣扎求生的温度。

## 外貌 · 神态 · 服装（按人物性格定制，彼此区分）
性子仗义的底层硬汉，在一次逃亡中主动为同伴断后，最终惨死。
