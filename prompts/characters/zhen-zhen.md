...
> 用途：生成 珍珍 的人物形象图。生成后请命名为 `zhen-zhen.png` 放入 `public/portraits/`，前端会自动显示。

## 人物身份
吴天胤身边人

## 性格与气质
痴情、隐忍。最了解吴天胤的女人，在他被亲情与时代逼到绝路时始终守在身边。

## 角色背景
珍珍见证了吴天胤被亲情与时代逼到绝路的全过程，是这条悲剧线的温度。

## 世界观设定（务必体现）
灾变之后、持续数十年的“冰封期”极寒末世。全球大面积冰封，资源极度匮乏，旧文明只剩废墟，新秩序在壁垒、特区与帮派之间艰难重建。整体基调阴冷、潮湿、压抑，但仍有人间烟火与挣扎求生的温度。

## 外貌 · 神态 · 服装（按人物性格定制，彼此区分）
最了解吴天胤的女人，在他被亲情与时代逼到绝路时始终守在身边。
