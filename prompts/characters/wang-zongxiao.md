...
> 用途：生成 王宗孝 的人物形象图。生成后请命名为 `wang-zongxiao.png` 放入 `public/portraits/`，前端会自动显示。

## 人物身份
龙城王家家主

## 性格与气质
精算、能屈能伸。和蔼可亲的表象下精于盘算的龙城王家掌门，能屈能伸。

## 角色背景
王家与秦禹由对立到妥协，最终散尽家财、低头求活躲过一劫。

## 世界观设定（务必体现）
灾变之后、持续数十年的“冰封期”极寒末世。全球大面积冰封，资源极度匮乏，旧文明只剩废墟，新秩序在壁垒、特区与帮派之间艰难重建。整体基调阴冷、潮湿、压抑，但仍有人间烟火与挣扎求生的温度。

## 外貌 · 神态 · 服装（按人物性格定制，彼此区分）
和蔼可亲的表象下精于盘算的龙城王家掌门，能屈能伸。
