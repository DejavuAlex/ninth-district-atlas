...
> 用途：生成 林耀宗 的人物形象图。生成后请命名为 `lin-yaozong.png` 放入 `public/portraits/`，前端会自动显示。

## 人物身份
总督，秦禹岳父（别称：林总督）

## 性格与气质
稳健、有格局。稳坐高位、施政有方的总督级人物，也是秦禹的岳父。

## 角色背景
林耀宗后期屡次示意秦禹接过总督之位，是连接权力顶层与亲情的人物。

## 世界观设定（务必体现）
灾变之后、持续数十年的“冰封期”极寒末世。全球大面积冰封，资源极度匮乏，旧文明只剩废墟，新秩序在壁垒、特区与帮派之间艰难重建。整体基调阴冷、潮湿、压抑，但仍有人间烟火与挣扎求生的温度。

## 外貌 · 神态 · 服装（按人物性格定制，彼此区分）
稳坐高位、施政有方的总督级人物，也是秦禹的岳父。
