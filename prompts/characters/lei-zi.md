...
> 用途：生成 雷子 的人物形象图。生成后请命名为 `lei-zi.png` 放入 `public/portraits/`，前端会自动显示。

## 人物身份
凶悍打手团首

## 性格与气质
凶悍、能打。手底下带着一支凶残能打的雷子团队，专干脏活硬仗的打手头目。

## 角色背景
雷子团队是秦禹一方可调动的暴力执行力量，干脏活、打硬仗。

## 世界观设定（务必体现）
灾变之后、持续数十年的“冰封期”极寒末世。全球大面积冰封，资源极度匮乏，旧文明只剩废墟，新秩序在壁垒、特区与帮派之间艰难重建。整体基调阴冷、潮湿、压抑，但仍有人间烟火与挣扎求生的温度。

## 外貌 · 神态 · 服装（按人物性格定制，彼此区分）
手底下带着一支凶残能打的雷子团队，专干脏活硬仗的打手头目。
