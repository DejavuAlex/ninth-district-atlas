...
const rawNinthDistrict: Omit<NovelDataset, "locations" | "characters"> & {
  ...
  locations: [
    { id: "planning-zone", name: "待规划区", kind: "wasteland", x: 93, y: 30, summary: "秦禹出身和故事起点所在的无政府边缘地带。", atmosphere: "贫瘠、粗粝、没有稳定规则。", factionIds: ["planned-zone"], eventIds: ["event-prologue", "event-yuan-ke-end"] },
    { id: "ninth-district", name: "第九特区", kind: "district", x: 78, y: 38, summary: "九区（第九特区）：松江、奉北、长吉等城所在的核心特区，也是身份、粮食与权力的入口，与七区、八区并称三大区。", atmosphere: "秩序表面稳定，底层竞争残酷。", factionIds: ["songjiang-police", "wu-line"], eventIds: ["event-qin-enters", "event-public-order"] },
    { id: "songjiang", name: "松江", kind: "city", x: 21.5, y: 28, summary: "九区核心城市，秦禹早期扎根之地，警务、黑街与政治利益在此交织。", atmosphere: "城市秩序和地下秩序并行。", sceneImage: "/scenes/songjiang.png", factionIds: ["songjiang-police", "black-street"], eventIds: ["event-police-team", "event-songjiang-return", "event-songjiang-takeover"] },
    ...
    { id: "jiangzhou", name: "江州", kind: "city", x: 33, y: 50, summary: "七区一带的重要城市，早期江湖交易与后期乱局都反复牵动于此。", atmosphere: "商路、家族和江湖人情交错。", factionIds: ["ma-family", "black-street"], eventIds: ["event-jiangzhou", "event-jiangzhou-chaos"] },
    { id: "fengbei", name: "奉北", kind: "city", x: 22, y: 68, summary: "九区的权力圈层与警务政治重镇，秦禹多次被卷入上层棋局。", atmosphere: "表面规矩森严，背后棋局密集。", factionIds: ["wu-line", "feng-line"], eventIds: ["event-fengbei", "event-pharma"] },
    { id: "changji", name: "长吉", kind: "city", x: 40, y: 46, summary: "九区的关键城市，故事在此由江湖斗争转向军事行动。", atmosphere: "道路、驻防和突袭成为新的语言。", factionIds: ["gu-line", "chuanfu"], eventIds: ["event-changji", "event-sword-changji"] },
    { id: "nanhu", name: "南沪", kind: "city", x: 44, y: 20, summary: "七区的政治舞台，南方巨头聚集、智囊与派系交锋频繁。", atmosphere: "会所、会议和暗线共同推动局势。", factionIds: ["chen-line", "military-intel"], eventIds: ["event-nanhu", "event-nanhu-fire"] },
    { id: "chuanfu", name: "川府", kind: "frontier", x: 57, y: 63, summary: "川府特区（川府城）：紧邻八区、九区的独立特区，秦禹后期立足、扩军、建立川府系的根据地。", atmosphere: "粮仓、生活镇和军队让秩序重新落地。", factionIds: ["chuanfu"], eventIds: ["event-chuanfu-entry", "event-chuanfu-war"] },
    { id: "five-zone", name: "五区", kind: "district", x: 47, y: 68, summary: "五区：盐岛所在、妖魔鬼怪齐聚的外部区域，牵动边境与外交压力。", atmosphere: "利益更复杂，合作和背叛更快切换。", factionIds: ["eu-zone", "chen-line"], eventIds: ["event-five-zone"] },
    { id: "seven-zone", name: "七区", kind: "district", x: 90, y: 64, summary: "七区：南沪、江州所在的特区，与八区、九区并称三大区，后期奔袭与驻防团冲突频发。", atmosphere: "边境紧绷，局部冲突随时升级。", factionIds: ["military-intel"], eventIds: ["event-seven-zone-raid"] },
    { id: "eight-zone", name: "八区", kind: "district", x: 37, y: 61, summary: "八区：与七区、九区并称三大区，毗邻川府，是后期战局的关键介入者。", atmosphere: "高层会议和军事压力共同落子。", factionIds: ["gu-line", "feng-line"], eventIds: ["event-eight-zone"] },
    { id: "eu-first-zone", name: "欧盟一区", kind: "frontier", x: 7, y: 46, summary: "外部势力代表区域，推动故事进入更大尺度的冲突。", atmosphere: "规则不同，谈判和军事威慑并行。", factionIds: ["eu-zone"], eventIds: ["event-eu-zone"] },
    ...
    { id: "yandao", name: "盐岛·盐业站", kind: "frontier", x: 72, y: 88, summary: "五区辖下盛产盐与资源的海岛据点，后期被川军一举插旗、鲸吞收编。", atmosphere: "盐场、码头与守军，海风咸冷、资源是这里的命脉。", factionIds: ["chuanfu", "chen-line"], eventIds: ["event-salt-island"] },
