...
export const ninthDistrict: NovelDataset = {
  ...
  arcs: [
    ...
    { id: "arc-spring", title: "故人月影与春暖花开", chapterRange: range(2686, 2744, "第二六八六章至第二七五一章"), summary: "战后余波、耶门落地、最后冲锋和故人重逢，让故事从硝烟回到人的选择。", keyEvents: ["event-yemen", "event-final-charge", "event-spring"], featuredLocations: ["yemen", "red-dan"], featuredCharacters: ["qin-yu", "xiang-zehao", "li-zhan", "xu-yan"] }
  ],
  events: [
    ...
    { id: "event-spring", title: "春暖花开", chapterRange: range(2744, 2744, "第二七五一章"), locationId: "ninth-district", characterIds: ["qin-yu", "lin-nianlei", "qi-lin", "lao-mao"], factionIds: ["chuanfu"], summary: "硝烟之后，故事以春暖花开的意象收束。", impact: "乱世中的牺牲和坚持最终回到人的生活。" }
  ],
  relationships: [
