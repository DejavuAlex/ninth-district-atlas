...
const rawNinthDistrict: Omit<NovelDataset, "locations" | "characters"> & {
  ...
  locations: [
    ...
    { id: "nanhu", name: "南沪", kind: "city", x: 60.0, y: 56.6, summary: "南方巨头聚集的政治舞台，智囊和派系交锋频繁。", atmosphere: "会所、会议和暗线共同推动局势。", factionIds: ["chen-line", "military-intel"], eventIds: ["event-nanhu", "event-nanhu-fire"] },
    { id: "chuanfu", name: "川府", kind: "frontier", x: 73.7, y: 43.4, summary: "秦禹后期立足、扩军和建立川府系的核心地盘。", atmosphere: "粮仓、生活镇和军队让秩序重新落地。", factionIds: ["chuanfu"], eventIds: ["event-chuanfu-entry", "event-chuanfu-war", "event-salt-island"] },
    { id: "five-zone", name: "五区", kind: "district", x: 65.0, y: 61.8, summary: "妖魔鬼怪齐聚的外部区域，牵动边境和外交压力。", atmosphere: "利益更复杂，合作和背叛更快切换。", factionIds: ["eu-zone", "chen-line"], eventIds: ["event-five-zone"] },
    { id: "seven-zone", name: "七区", kind: "district", x: 89.4, y: 60.5, summary: "后期奔袭和驻防团冲突的重要区域。", atmosphere: "边境紧绷，局部冲突随时升级。", factionIds: ["military-intel"], eventIds: ["event-seven-zone-raid"] },
    { id: "eight-zone", name: "八区", kind: "district", x: 71.9, y: 32.9, summary: "后期战局介入者，影响九区和川府的政治平衡。", atmosphere: "高层会议和军事压力共同落子。", factionIds: ["gu-line", "feng-line"], eventIds: ["event-eight-zone"] },
    { id: "eu-first-zone", name: "欧盟一区", kind: "frontier", x: 14.4, y: 43.4, summary: "外部势力代表区域，推动故事进入更大尺度的冲突。", atmosphere: "规则不同，谈判和军事威慑并行。", factionIds: ["eu-zone"], eventIds: ["event-eu-zone"] },
    { id: "old-triangle", name: "老三角", kind: "frontier", x: 83.1, y: 73.7, summary: "后期目光聚集的边境地带，军情和战场压力交织。", atmosphere: "潮湿、混乱、到处是临时阵线。", factionIds: ["military-intel", "chuanfu"], eventIds: ["event-old-triangle"] },
    { id: "bar-city", name: "巴尔城", kind: "battlefield", x: 51.2, y: 35.5, summary: "北伐阶段的重要攻坚目标，城市攻防成为大结局前的焦点。", atmosphere: "炮火、围城和心理战压到极限。", factionIds: ["eu-zone", "chuanfu"], eventIds: ["event-bar-city"] },
    { id: "yemen", name: "耶门", kind: "frontier", x: 45.0, y: 71.0, summary: "结尾阶段外部谈判和再赴战场的落点之一。", atmosphere: "远离故土，却仍被华区战局牵动。", factionIds: ["military-intel", "eu-zone"], eventIds: ["event-yemen"] },
    { id: "red-dan", name: "红丹战场", kind: "battlefield", x: 62.5, y: 73.7, summary: "最终决战附近的象征性战场，承接北伐后的最后冲锋。", atmosphere: "疲惫、牺牲和最后的国仇家恨集中爆发。", factionIds: ["chuanfu", "military-intel"], eventIds: ["event-final-charge"] }
  ],
  arcs: [
