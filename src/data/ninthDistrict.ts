...
const locationScenes: Record<string, string> = {
  ...
  "ninth-district":
    "九区门户，相对成型、有秩序的特区门户：高大壁垒、检查站与配给点环绕，凭身份和粮票才能立足；街道冷硬却运转有序、岗哨规整，比区外废土体面太多，是无数人挤破头想进来的‘里面’。",
  "songjiang":
...
const rawNinthDistrict: Omit<NovelDataset, "locations" | "characters"> & {
  ...
  locations: [
    { id: "planning-zone", name: "待规划区", kind: "wasteland", x: 31, y: 44, summary: "秦禹出身和故事起点所在的无政府边缘地带。", atmosphere: "贫瘠、粗粝、没有稳定规则。", factionIds: ["planned-zone"], eventIds: ["event-prologue", "event-yuan-ke-end"] },
    { id: "ninth-district", name: "第九特区", kind: "district", x: 52, y: 28, summary: "九区（第九特区）：松江、奉北、长吉等城所在的核心特区，也是身份、粮食与权力的入口，与七区、八区并称三大区。", atmosphere: "秩序表面稳定，底层竞争残酷。", factionIds: ["songjiang-police", "wu-line"], eventIds: ["event-qin-enters", "event-public-order"] },
    { id: "songjiang", name: "松江", kind: "city", x: 52, y: 36, summary: "九区核心城市，秦禹早期扎根之地，警务、黑街与政治利益在此交织。", atmosphere: "城市秩序和地下秩序并行。", sceneImage: "/scenes/songjiang.webp", factionIds: ["songjiang-police", "black-street"], eventIds: ["event-police-team", "event-songjiang-return", "event-songjiang-takeover"] },
    { id: "black-street", name: "黑街", kind: "street", x: 48, y: 39, summary: "秦禹、老猫和马家频繁活动的灰色地带。", atmosphere: "饭局、码牌、枪声和人情并存。", factionIds: ["black-street", "ma-family"], eventIds: ["event-black-street", "event-ma-alliance"] },
    { id: "tuzha-street", name: "土渣街", kind: "street", x: 49, y: 43, summary: "早期冲突集中爆发的街区，秦禹从这里切入地下规则。", atmosphere: "低矮、拥挤、一步错就会被吞掉。", factionIds: ["black-street"], eventIds: ["event-tuzha-street", "event-three-parties"] },
    { id: "jiangzhou", name: "江州", kind: "city", x: 82, y: 43, summary: "七区一带的重要城市，早期江湖交易与后期乱局都反复牵动于此。", atmosphere: "商路、家族和江湖人情交错。", factionIds: ["ma-family", "black-street"], eventIds: ["event-jiangzhou", "event-jiangzhou-chaos"] },
    { id: "fengbei", name: "奉北", kind: "city", x: 53, y: 41, summary: "九区的权力圈层与警务政治重镇，秦禹多次被卷入上层棋局。", atmosphere: "表面规矩森严，背后棋局密集。", factionIds: ["wu-line", "feng-line"], eventIds: ["event-fengbei", "event-pharma"] },
    { id: "changji", name: "长吉", kind: "city", x: 51, y: 46, summary: "九区的关键城市，故事在此由江湖斗争转向军事行动。", atmosphere: "道路、驻防和突袭成为新的语言。", factionIds: ["gu-line", "chuanfu"], eventIds: ["event-changji", "event-sword-changji"] },
    { id: "nanhu", name: "南沪", kind: "city", x: 73, y: 42, summary: "七区的沿海港口都市，设有海港码头与远洋贸易，是南方巨头聚集、智囊与派系交锋的政治舞台。", atmosphere: "码头、货轮与远洋商路连通内外，会所、会议和暗线共同推动局势。", factionIds: ["chen-line", "military-intel"], eventIds: ["event-nanhu", "event-nanhu-fire"] },
    { id: "chuanfu", name: "川府", kind: "frontier", x: 47, y: 44, summary: "川府特区（川府城）：紧邻八区、九区的独立特区，秦禹后期立足、扩军、建立川府系的根据地。", atmosphere: "粮仓、生活镇和军队让秩序重新落地。", factionIds: ["chuanfu"], eventIds: ["event-chuanfu-entry", "event-chuanfu-war"] },
    { id: "five-zone", name: "五区", kind: "district", x: 47, y: 62, summary: "五区：盐岛所在、妖魔鬼怪齐聚的外部区域，牵动边境与外交压力。", atmosphere: "利益更复杂，合作和背叛更快切换。", factionIds: ["eu-zone", "chen-line"], eventIds: ["event-five-zone"] },
  ...
  events: [
    ...
    { id: "event-qin-enters", title: "秦禹初入第九特区", chapterRange: range(2, 18, "第一章至第十七章"), locationId: "ninth-district", characterIds: ["qin-yu", "lao-mao"], factionIds: ["planned-zone", "songjiang-police"], summary: "秦禹通过身份和工作机会进入九区，开始接触新的城市规则。", impact: "主角完成从区外流民到区内办事者的身份转换。" },
    { id: "event-police-team", title: "三组关系成形", chapterRange: range(7, 39, "第七章至第三十八章"), locationId: "songjiang", characterIds: ["qin-yu", "qi-lin", "lao-mao"], factionIds: ["songjiang-police"], summary: "秦禹进入警务小组，与齐麟、老猫等人形成早期互信。", quote: "咱俩要是普通人也就拉倒了，可身上穿着这身皮，碰见了就不能不管啊。", quoteContext: "老猫对秦禹说起警务职责", impact: "兄弟线和警务线成为前期主轴。" },
    { id: "event-public-order", title: "九区众生相显露", chapterRange: range(18, 45, "第十七章至第四十五章"), locationId: "ninth-district", characterIds: ["qin-yu", "lao-mao"], factionIds: ["songjiang-police", "black-street"], summary: "警务、街面和底层人物共同展示九区的现实规则。", quote: "再牛B的理想，也干不过现实。", quoteContext: "老李看透九区现实", impact: "秦禹看到法律之外还有利益和人情。" },
    { id: "event-tuzha-street", title: "土渣街风起", chapterRange: range(10, 42, "第九章至第四十一章"), locationId: "tuzha-street", characterIds: ["qin-yu", "yuan-ke"], factionIds: ["black-street", "yuan-family"], summary: "土渣街冲突把秦禹推到袁克和地下势力面前。", quote: "咱们一口锅内吃饭，只是角色不同，但本质相同，那就是在这个乱糟糟的环境里，活的稍微好一点。", quoteContext: "袁克的生存哲学", impact: "早期敌对关系明朗，秦禹开始以硬手段求生。" },
    { id: "event-three-parties", title: "三家齐聚土渣街", chapterRange: range(41, 42, "第四十一章前后"), locationId: "tuzha-street", characterIds: ["qin-yu", "ma-lao-er", "yuan-ke"], factionIds: ["black-street", "ma-family", "yuan-family"], summary: "多方势力在土渣街码牌，街面冲突背后有更复杂的靠山。", quote: "这个年代，讲吃喝的有，讲生存的有，但我还没听到谁讲什么原则呢。", quoteContext: "马老爷子的老江湖判断", impact: "秦禹意识到黑街不是单点斗狠，而是多家利益互相压制。" },
    ...
    { id: "event-ma-alliance", title: "马家关系建立", chapterRange: range(75, 218, "第七十五章至第二一八章"), locationId: "black-street", characterIds: ["qin-yu", "ma-lao-er", "ma-lao-ye"], factionIds: ["ma-family", "black-street"], summary: "马老二与马老爷子让秦禹接触到另一种江湖规则。", quote: "我兜里今天有一百，全花了，明天死了就不亏。", quoteContext: "马老二的江湖性情", impact: "秦禹获得能对抗袁家的地下盟友。" },
    { id: "event-human-trade", title: "人口贩卖线索出现", chapterRange: range(240, 270, "第二四零章至第二六九章"), locationId: "songjiang", characterIds: ["qin-yu", "fu-xiaohao"], factionIds: ["songjiang-police"], summary: "秦禹听闻人口贩子线索，案件背后牵出更复杂的利益网。", quote: "我们这种穷孩子，生下来没出路，只能自己找出路呗。", quoteContext: "付小豪说出底层向上的理由", impact: "警务线从街面纠纷进入更黑暗的犯罪链条。" },
    ...
    { id: "event-wu-tianyin-search", title: "寻找吴天胤", chapterRange: range(477, 483, "第四七七章至第四八三章"), locationId: "songjiang", characterIds: ["qin-yu", "wu-tianyin"], factionIds: ["black-street", "songjiang-police"], summary: "吴天胤走向极端后，黑白两道同时寻找他的踪迹。", quote: "我以前是犯了错，可我现在跟普通人一样啊！", quoteContext: "吴天胤出狱后的求生愿望", impact: "个人悲剧转化为松江权力洗牌的导火索。" },
    { id: "event-songjiang-return", title: "杀回松江", chapterRange: range(553, 581, "第五五三章至第五八一章"), locationId: "songjiang", characterIds: ["qin-yu", "qi-lin", "wu-tianyin"], factionIds: ["songjiang-police", "black-street"], summary: "秦禹一方重新杀回松江，在北站等节点爆发激战。", quote: "我赚钱养活你……你他妈却剥夺了我最后一点尊严……", quoteContext: "齐麟被逼到绝境的呐喊", impact: "秦禹从被动应对转为主动夺回局面。" },
    { id: "event-yuan-ke-end", title: "待规划区斩袁克", chapterRange: range(617, 620, "第六一七章至第六二零章"), locationId: "planning-zone", characterIds: ["qin-yu", "yuan-ke"], factionIds: ["yuan-family", "planned-zone"], summary: "袁克的命运在待规划区终结，早期最大敌手退出舞台。", quote: "有些事儿人在做，天在看……我他妈就不信", quoteContext: "阿龙临死前留下的控诉", impact: "秦禹完成前期复仇和清障，松江进入新阶段。" },
    { id: "event-yaoguang", title: "耀光交易线开启", chapterRange: range(637, 643, "第六三七章至第六四三章"), locationId: "songjiang", characterIds: ["qin-yu", "lin-chengdong", "zhan-nan"], factionIds: ["black-street", "songjiang-police"], summary: "秦禹看货、交易、入驻新渠道，资源组织能力开始显现。", quote: "走两次货你就会明白，我于瑾年三个字就是质量的保证。", quoteContext: "于瑾年初做药品走货时", impact: "他不再只是办案，而是经营人和货的网络。" },
    ...
    { id: "event-nanhu", title: "南沪巨头聚集", chapterRange: range(1061, 1111, "第一零六六章至第一一一一章"), locationId: "nanhu", characterIds: ["qin-yu", "wu-di", "gu-yan"], factionIds: ["wu-line", "gu-line", "chen-line"], summary: "南沪成为巨头汇聚之地，秦禹被迫在各方之间寻找落点。", quote: "没有的话，我来安排，一切消费都算我的！！", quoteContext: "顾言出场时的豪阔做派", impact: "南方政治线开始影响秦禹的整体布局。" },
    ...
    { id: "event-pharma", title: "药业集团落子", chapterRange: range(1121, 1128, "第一一二六章至第一一二八章"), locationId: "fengbei", characterIds: ["qin-yu", "ke-ke", "wu-di"], factionIds: ["wu-line"], summary: "药业集团成为新的利益承载物，资本和权力比枪火更隐蔽。", quote: "天成宝丰药厂的股份划分，主要来源于技术，销售，资本投资，以及政治关系四个方面。", quoteContext: "原文旁白，药业集团股权结构", impact: "秦禹学会用组织和产业抵抗单纯暴力。" },
    ...
    { id: "event-chuanfu-entry", title: "落地川府", chapterRange: range(1279, 1288, "第一二八四章至第一二八八章"), locationId: "chuanfu", characterIds: ["qin-yu", "xiang-zehao"], factionIds: ["chuanfu"], summary: "秦禹进入川府，面对远山生活镇和新地盘的现实问题。", quote: "我跟你一块去，我不怕遭罪。", quoteContext: "林念蕾随秦禹离开松江前", impact: "全书核心地盘转换，秦禹从城市斗争走向建制扩张。" },
    ...
    { id: "event-grain-army", title: "粮仓与十万军", chapterRange: range(1519, 1526, "第一五二四章至第一五二六章"), locationId: "chuanfu", characterIds: ["qin-yu", "ke-ke"], factionIds: ["chuanfu"], summary: "百万亩粮仓和军队规模成为川府系向上攀登的基础。", quote: "茫茫雪原，百万亩粮仓，十万预备役，这就是铁帽子王要一步登天梯的底牌。", quoteContext: "原文旁白，川府粮仓与兵力", impact: "资源、粮食和军队完成绑定，川府系进入上升通道。" },
    ...
    { id: "event-border-massacre", title: "边境风波升级", chapterRange: range(1677, 1688, "第一六八二章至第一六八八章"), locationId: "old-triangle", characterIds: ["qin-yu", "ke-ke"], factionIds: ["military-intel", "chuanfu"], summary: "边境屠杀引发众将规劝，可可看出新的契机。", quote: "我们是锄头，是筐，是采参的棒子，但就不是人，呵呵。", quoteContext: "大牙说起矿场编号，也照见底层苦难", impact: "人道惨剧转化为战略调整的理由。" },
    ...
    { id: "event-eu-zone", title: "出发欧盟一区", chapterRange: range(1656, 1661, "第一六六一章前后"), locationId: "eu-first-zone", characterIds: ["qin-yu", "ke-hua"], factionIds: ["eu-zone", "military-intel"], summary: "外部力量的规则和压力进入主线，秦禹阵营需要面对不同体系。", quote: "九区的内政问题，不容任何组织和政党干预！", quoteContext: "项择昊对外部势力表态", impact: "故事视野从华区内部扩展到更复杂的外部秩序。" },
    { id: "event-salt-island", title: "川军插旗盐岛", chapterRange: range(1997, 2004, "第二零零一章至第二零零四章"), locationId: "yandao", characterIds: ["qin-yu", "da-ya", "meng-xi"], factionIds: ["chuanfu"], summary: "战后川军插旗，鲸吞盐岛，川府系炙手可热。", quote: "秦黑子就是干地面起家的", quoteContext: "孟玺判断川府兵命的分量", impact: "秦禹的地方势力正式获得更大政治分量。" },
    { id: "event-songjiang-takeover", title: "一步步拿下松江", chapterRange: range(2077, 2084, "第二零八一章至第二零八四章"), locationId: "songjiang", characterIds: ["qin-yu", "feng-ji"], factionIds: ["chuanfu", "feng-line"], summary: "案件真相和匿名电话交织，松江控制权被逐步撬动。", quote: "枪打出头鸟，你做事如果太过独断专行，那就一定有。", quoteContext: "周兴礼谈权力反制", impact: "早期起点城市被重新纳入秦禹的权力版图。" },
    ...
    { id: "event-li-bokang-plan", title: "李伯康计划推进", chapterRange: range(2470, 2548, "第二四七七章至第二五四八章"), locationId: "nanhu", characterIds: ["li-bokang", "feng-ji", "qin-yu"], factionIds: ["feng-line", "military-intel"], summary: "李伯康的蓝图和计划不断推进，秦禹一方被迫应对更细密的局。", quote: "我和别人不一样，用我之前，你们最好想好了。", quoteContext: "李伯康出山前的自负宣言", impact: "最终战争前，智谋对抗几乎和正面战场同等重要。" },
    { id: "event-nanhu-fire", title: "炮打南沪", chapterRange: range(2487, 2538, "第二四九四章至第二五三八章"), locationId: "nanhu", characterIds: ["qin-yu", "li-bokang"], factionIds: ["chen-line", "feng-line", "chuanfu"], summary: "南沪城内勾心斗角持续，炮火让政治斗争彻底军事化。", quote: "什么叫掀桌子啊？这是自卫反击，是为了和平与自由！", quoteContext: "吴迪把政治冲突包装成正义话术", impact: "各派再难维持体面，终局冲突正式燃起。" },
    { id: "event-north-expedition", title: "兵出如龙北伐", chapterRange: range(2652, 2674, "第二六五九章至第二六七四章"), locationId: "red-dan", characterIds: ["qin-yu", "da-ya", "ke-hua"], factionIds: ["chuanfu", "military-intel"], summary: "战事再次升级，大牙被征召，北伐兵锋出动。", quote: "诸位，请保我华夏未来百年无战事！进攻！！", quoteContext: "秦禹北伐总攻令", impact: "秦禹阵营从防守和局部争夺转向战略进攻。" },
    { id: "event-bar-city", title: "巴尔城破", chapterRange: range(2653, 2685, "第二六六零章至第二六八五章"), locationId: "bar-city", characterIds: ["qin-yu", "da-ya", "li-zhan"], factionIds: ["chuanfu", "eu-zone"], summary: "巴尔城从诡异局面到兵围城破，攻坚成为北伐关键节点。", quote: "哥几个，好好活着，替我活着！", quoteContext: "老魏牺牲前的嘶吼", impact: "外部战线被打开，大结局前的军事目标相继完成。" },
    ...
    { id: "event-final-charge", title: "再赴战场", chapterRange: range(2697, 2743, "第二七零四章至第二七五零章"), locationId: "red-dan", characterIds: ["xiang-zehao", "li-zhan", "xu-yan"], factionIds: ["chuanfu", "military-intel"], summary: "决战前夕再赴战场，最后冲锋中有人牺牲，有人完成使命。", quote: "登陆耶门也让我们待命", quoteContext: "历战急着再赴战场", impact: "个人命运和国族叙事在终局汇合。" },
    { id: "event-spring", title: "春暖花开", chapterRange: range(2743, 2743, "第二七五零章后尾声"), locationId: "ninth-district", characterIds: ["qin-yu", "lin-nianlei", "qi-lin", "lao-mao"], factionIds: ["chuanfu"], summary: "硝烟之后，故事以春暖花开的意象收束。", quote: "在我有生之年，希望能看到咱们的家乡春暖花开，阳光普照吧。", quoteContext: "周司令的心愿", impact: "乱世中的牺牲和坚持最终回到人的生活。" }
  ],
  relationships: [
  ...
  characters: [
    character({ id: "qin-yu", name: "秦禹", aliases: ["秦老黑", "禹少"], factionIds: ["songjiang-police", "black-street", "chuanfu"], firstSeen: range(1, 2, "序章至第一章"), role: "主角，川府系核心", profile: "从待规划区走出的青年，凭狠劲、判断力和组织能力不断向上。", story: "秦禹本是待规划区里只想活下去的流民，用一个买来的身份挤进第九特区，在松江的警务与黑街夹缝中求生。他靠狠劲与算计立足黑街、结盟马家，又在待规划区亲手了结了早期最大的对手袁克。此后他从办案者变成经营货路与人脉的资源组织者，一步步走进奉北、南沪的上层棋局；马踏长吉一役，江湖斗争升级为成建制的军事行动。落地川府后，他从远山生活镇经营到百万亩粮仓、十万雄兵，又插旗盐岛、炮打南沪，终于不再寄人篱下。最终他率三十万大军北伐出关，从一个买命求生的青年走成一直在冲锋路上的上将，用近四十年的厮杀换来三大区的春暖花开。", quote: "诸位，请保我华夏未来百年无战事！进攻！！", quoteContext: "北伐出关·三十万大军总攻令", traits: ["冷静", "能忍", "重情义", "善于借势"], locationIds: ["planning-zone", "ninth-district", "songjiang", "chuanfu", "nanhu", "bar-city"] }),
    character({ id: "qi-lin", name: "齐麟", aliases: ["麒麟"], factionIds: ["songjiang-police", "chuanfu"], firstSeen: range(1, 37, "序章至第三十六章"), role: "秦禹早期兄弟", profile: "从艰难处境中被逼着成长的伙伴，和秦禹有很深的患难基础。", story: "齐麟是秦禹进入松江警务时第一个对他好的同事，圆滑热心，带着秦禹跑遍警司五层楼、介绍每一条规矩，两盒中华烟换来了最初的情谊。他攒钱砍了三次价，花钱买来白俄女孩贝拉做老婆，却在一次加班归来时推开柜门，撞破贝拉与老虎的私情，砸出那句我赚钱养活你，你他妈却剥夺了我最后一点尊严。接连的打击让他失去理智，杀了人、丢了工作、负了伤，带着老母和小妹家破人亡地逃出松江。此后他在军政体系中一路成长，后期在鲁区拉起八万人的部队，成为秦禹阵营不可或缺的战场臂膀。", quote: "我赚钱养活你……你他妈却剥夺了我最后一点尊严……", quoteContext: "被逼到绝境的呐喊", traits: ["忠诚", "坚韧", "敏感"], locationIds: ["songjiang", "ninth-district"] }),
    character({ id: "lao-mao", name: "老猫", aliases: ["李富贵", "猫哥"], factionIds: ["songjiang-police", "black-street"], firstSeen: range(3, 40, "第三章至第四十章"), role: "警务搭档，兄弟线核心", profile: "圆滑、会做人，也能在关键时刻顶上去。", story: "老猫真名李富贵，跟警务司李司长有层说不清的关系，平时一副吊儿郎当的圆滑样，却和秦禹一见如故。他和秦禹一起盯住街面上的可疑人，手无寸铁又不肯撒手，一句身上穿着这身皮，碰见了就不能不管，把玩世不恭背后的职责感露了出来。此后老猫一直是秦禹在松江早期最得力的搭档，借人情、走关系，用市井经验补足秦禹的锋芒。两人的情谊从警司大楼、黑街饭桌一直延续到最后的春暖花开。", quote: "咱俩要是普通人也就拉倒了，可身上穿着这身皮，碰见了就不能不管啊。", quoteContext: "对职责的朴素坚持", traits: ["圆滑", "义气", "机敏"], locationIds: ["songjiang", "black-street"] }),
    character({ id: "ma-lao-er", name: "马老二", aliases: ["二哥"], factionIds: ["ma-family", "black-street"], firstSeen: range(75, 76, "第七十五章至第七十六章"), role: "马家年轻一代", profile: "黑街中的奇人，讲面子也敢下狠手。", story: "马老二是黑街马家年轻一代的扛把子，在土渣街跟着三叔卖禁药，嚣张到把警司来抓人的都不放在眼里。秦禹突袭抓他时一脚蹬飞、枪托磕掉他两颗门牙，提审室里又把他踹到认怂，这场硬碰硬反倒让他服了这个人。出来之后，他和秦禹从互相试探走向结盟，一次险些丢命的风波里，有人替他扛下案子，他喊出今天有一百全花了、明天死了不亏。豪横之中藏着性情，马家也借这条线和秦禹深度绑定。", quote: "我兜里今天有一百，全花了，明天死了就不亏。", quoteContext: "江湖人的及时行乐", traits: ["豪横", "讲义气", "会办事"], locationIds: ["black-street", "jiangzhou"] }),
    character({ id: "ma-lao-ye", name: "马老爷子", aliases: ["马老"], factionIds: ["ma-family"], firstSeen: range(14, 15, "第十四章"), role: "老江湖", profile: "马家的根基人物，代表旧江湖的经验和分量。", story: "马老爷子是马家在黑街的根基人物，代表老一辈江湖的分量。秦禹刚破了土渣街药案、抓了马老二，他裹着大皮袄坐在电动车里，让人拎着两万块钱来打招呼，笑着说这个年代讲吃喝和生存的多，却少有人讲原则。秦禹没有接钱，也没能让他捞出人，老爷子却看清了这个新警员的分量。此后马家与秦禹从试探走向结盟，他那句关于原则的话，成了黑街关系最真实的底色。", quote: "这个年代，讲吃喝的有，讲生存的有，但我还没听到谁讲什么原则呢。", quoteContext: "老江湖的处世观", traits: ["老辣", "稳重"], locationIds: ["black-street"] }),
    character({ id: "yuan-ke", name: "袁克", aliases: [], factionIds: ["yuan-family"], firstSeen: range(40, 41, "第四十章"), role: "前期主要敌手", profile: "依托家族和资源压迫秦禹，是松江早期冲突的核心反派。", story: "袁克初见秦禹时满口现实逻辑，说大家一口锅内吃饭，只是角色不同，本质都是在乱糟糟的环境里活得稍微好一点。可他依托家族资源，在松江警务系统和黑街双线布局，把救命药品与街面利益攥在手里层层盘剥。阿龙在提审室里咬碎假牙自尽前，冲着他留下人在做、天在看的控诉，他仍然没有回头。最终袁克在待规划区迎来结局，早年从那里走出的秦禹，在荒原风雪里终结了这个前期最大敌手。", quote: "咱们一口锅内吃饭，只是角色不同，但本质相同，那就是在这个乱糟糟的环境里，活的稍微好一点。", quoteContext: "反派的生存哲学", traits: ["阴狠", "自负", "资源充足"], locationIds: ["songjiang", "planning-zone"] }),
    character({ id: "lin-nianlei", name: "林念蕾", aliases: [], factionIds: ["wu-line", "chuanfu"], firstSeen: range(1121, 1205, "第一一二六章至第一二零五章"), role: "秦禹情感线重要人物", profile: "她把秦禹从战争和权谋中拉回私人情感。", story: "林念蕾来自奉北，舅舅在当地大公司担任高层，她却选择去松江做网播台法制专栏记者。她第一次走进秦禹生活，是把一盘热乎乎的油条挂在早晨的门框上，一句都是邻居相互帮忙嘛，就把冰冷世界里少见的温度递了过去。她从来不是柔弱的女孩，争着进案发现场采访，被军方拘押时喊出将军都不能剥夺我的尊严。后来秦禹说可能要离开松江，她靠在他胳膊上看星星，说我跟你一块去，我不怕遭罪，从此成为战争年代里那份没有被炮火磨尽的温柔。", quote: "将军都不能剥夺我的尊严，你们又算个什么东西？！", quoteContext: "柔弱外表下的刚烈", traits: ["清醒", "温柔", "有主见"], locationIds: ["fengbei", "ninth-district"] }),
    character({ id: "wu-di", name: "吴迪", aliases: [], factionIds: ["wu-line"], firstSeen: range(608, 608, "第六零八章"), role: "政治资源入口", profile: "有谋略和现实判断的上层人物。", story: "吴迪是秦禹进入上层政治圈后最早接触的军政青年派人物之一。他的价值不在开枪，而在懂得什么时候开口、什么时候沉默，在饭局上能把掀桌子轻巧转成自卫反击、和平与自由，既护住局面，也把秦禹推到正义一方。奉北和南沪的政治棋局里，他多次为秦禹运作门路、打通上层关系。吴迪与秦禹之间是互借之势，双方都清楚彼此不是无条件的，但关键时刻，他仍是秦禹能叫到的那个名字。", quote: "什么叫掀桌子啊？这是自卫反击，是为了和平与自由！", quoteContext: "政客的话术", traits: ["理性", "精明", "懂权衡"], locationIds: ["fengbei", "nanhu"] }),
    character({ id: "gu-yan", name: "顾言", aliases: [], factionIds: ["gu-line"], firstSeen: range(760, 760, "第七六零章"), role: "军政盟友", profile: "名字本身就有分量，背后牵动更大的资源。", story: "顾言是秦禹在南沪学习培训期间认识的，飞机上一句我叫顾言，八区燕北过来的，便是两人相识的起点。他出手豪阔，一到地方就张嘴安排消费，背后是八区顾系深厚的根基。随着故事推进，顾言代表的顾系力量在长吉战役、八区内战和后期大战中屡次影响局势。秦禹从街面人物走向军政层级，顾言既是盟友，也是那把替川府系挡过政治风险的伞。", quote: "没有的话，我来安排，一切消费都算我的！！", quoteContext: "顾家的豪阔做派", traits: ["有背景", "果断", "讲合作"], locationIds: ["changji", "eight-zone", "liu-zone"] }),
    character({ id: "ke-ke", name: "于瑾年", aliases: ["可可", "于总"], factionIds: ["chuanfu", "wu-line"], firstSeen: range(57, 57, "第五十七章"), role: "药业供货商 · 药业集团一把手", profile: "本名于瑾年、小名可可：从松江药品走货起家的精明女商人，子承父业、几个哥哥都不如她；后成长为药业集团（天成宝丰）总经理、副总裁，是秦禹阵营最重要的资源与布局支点。", story: "可可初登场是松江一带做药品走货的供货商，红唇大眼、能喝善谈，开口就是‘我于瑾年三个字就是质量的保证’。她子承父业、心思缜密，先期款不到五成绝不放货，却也最早看准并扶持了起步阶段的秦禹。此后她从走货商一路做到药业集团一把手，被称作‘于总’，是集团里唯一真正懂经营的人，带头操办慈善与产业布局，把秦禹阵营的人情和资本拧成一股绳。她在长吉市场布局、与职业经理人卢伟德的博弈中据理力争，也曾被苏庸主导的奉北经侦署突袭抓捕，秦禹倾尽全力反击营救。她敏锐、务实、敢落子，是贯穿药业、川府与边境多个阶段的智力核心。", quote: "走两次货你就会明白，我于瑾年三个字就是质量的保证。", quoteContext: "初做药品走货时", traits: ["精明缜密", "能言善断", "务实敢布局", "外柔内刚"], locationIds: ["songjiang", "fengbei", "chuanfu", "old-triangle"] }),
    character({ id: "lin-chengdong", name: "林成栋", aliases: [], factionIds: ["black-street"], firstSeen: range(649, 649, "第六四九章"), role: "交易线伙伴", profile: "中庸谨慎，但能在交易和资源网络中发挥作用。", story: "林成栋初登场于南沪学习线，是东埔区治安站警长，也是秦禹和顾言的同寝室学员。原文直接用中庸来形容他：不刻意攀附顾言，也不因家境普通而自卑逢迎，寝室有活就顺手做，别人叫他出去高消费，他也坦然说自己跟不上。这个人没有锋芒毕露的狠劲，却有普通人最稳的一面：知道分寸、守住本心，也愿意在秦禹受伤时半夜爬起来找药酒帮忙。后来他参与秦禹的货路和交易线，是灰色商路里那种不耀眼却能让局面稳定下来的伙伴。", traits: ["谨慎", "务实"], locationIds: ["songjiang", "jiangzhou"] }),
    character({ id: "zhan-nan", name: "展楠", aliases: [], factionIds: ["songjiang-police", "black-street"], firstSeen: range(655, 655, "第六五五章"), role: "行动人员", profile: "能在灰色事务中压住局面的人。", story: "展楠是顾言在七区线上的铁磁，第一次与秦禹见面，就是顾言带他上车介绍双方认识。他不是中心棋手，却熟悉七区跑道、货路和当地规则，关键时刻一通电话就能知道货被稽查扫掉的消息，也能把复杂局面讲清楚。六爷说今天没有展楠，秦禹光折一条腿肯定不好使，可见他在这条线上有实打实的人脉和分量。展楠的作用不在于名场面，而在于把秦禹从松江带到更复杂的七区、南沪江湖网络中，是早期外部商路的重要连接点。", traits: ["强硬", "可靠"], locationIds: ["songjiang"] }),
    character({ id: "fu-xiaohao", name: "付小豪", aliases: [], factionIds: ["songjiang-police"], firstSeen: range(238, 239, "第二三八章"), role: "案件线人物", profile: "前期案件和利益输送线中的关键人。", story: "付小豪出身奉北郊区生活村，说起家境时会低头，觉得没面子，却也把自己的想法说得直白：穷孩子生下来没出路，只能自己找出路，进体制才有机会，当官才能出人头地。他和丁国珍一起进入秦禹的小队，最早带着一点青涩和现实，也带着普通底层青年向上爬的强烈欲望。秦禹专门把兄弟们叫到警司食堂聚餐，就是为了让他们融进这个圈子。付小豪在案件线和早期警务线里承担执行角色，他的存在让秦禹身边不只有老江湖，也有被时代推着往前跑的新一代小人物。", traits: ["机灵", "现实"], locationIds: ["songjiang", "fengbei"] }),
    character({ id: "li-zhan", name: "历战", aliases: [], factionIds: ["chuanfu", "military-intel"], firstSeen: range(555, 555, "第五五五章"), role: "战场尖刀", profile: "能打硬仗、敢接高危任务的军事骨干。", story: "历战是秦禹阵营里打硬仗的那把刀，说话做事都带着战场逻辑。他能冷静分析对手是老牌私人武装，安排用刚到之兵冲击苦战旧部，也能把戴罪立功的人重新放到战场上发挥最后价值。北风口和耶门阶段，当秦禹让他待命，他急到亲自坐飞机去找病号秦老黑抗议，质问自己的兵到底是上不了战场，还是不会开枪。这股争着上阵的劲儿，正是历战最鲜明的底色。", quote: "呵呵，稳住神。咱和他们也没仇，还给他们送钱，人家没必要犯邪心。", quoteContext: "临战前安抚同伴", traits: ["勇猛", "直接", "抗压"], locationIds: ["seven-zone", "old-triangle", "red-dan", "beifengkou"] }),
    character({ id: "da-ya", name: "大牙", aliases: [], factionIds: ["chuanfu"], firstSeen: range(257, 258, "第二五七章"), role: "军事指挥和骨干", profile: "从早期来电到后期军事才能被运作，是川府战场线重要人物。", story: "大牙是从山里矿场爬出来的人，脖子上那个纹身数字三零八八，是矿主给他的编号。秦禹帮他剃头时发现这串数字，才听他说起雪崩死人后，老板靠数字核对谁没了，他不是人，只是锄头、筐、采参的棒子。秦禹听完眼圈发红，也真正看见了底层被碾碎的样子。后来大牙进了军队，凭骨子里的猛劲一路成长，从山里的矿工数字变成川府军事体系的一把利刃，在扩军与北伐中扛起真正属于自己的枪。", quote: "我们是锄头，是筐，是采参的棒子，但就不是人，呵呵。", quoteContext: "控诉矿场把人当数字", traits: ["能打", "会带兵", "忠诚"], locationIds: ["chuanfu", "bar-city", "red-dan"] }),
    character({ id: "wu-tianyin", name: "吴天胤", aliases: ["胤哥"], factionIds: ["planned-zone", "black-street"], firstSeen: range(481, 481, "第四八一章"), role: "极端乱世人物", profile: "被时代和亲情逼到极端的人物。", story: "吴天胤出狱后只想谋一条普通活路，却被领导当众羞辱，身上的脏点仿佛一辈子也洗不掉。母亲改嫁，继父和同母异父的兄弟嫌他拖累，亲情与时代把他一步步逼上另一条路。后来他聚起自己的兄弟，被人叫作胤哥，又以五个亿军费为条件加入同盟，出任吴系佣兵集团司令，驻守北风口。自由党铁骑压境时，他宁可自己战死，也要让兄弟们的老婆孩子撤出去，完成了这个被世界抛弃之人的自我救赎。", quote: "我以前是犯了错，可我现在跟普通人一样啊！我需要工作，我得养活自己。", quoteContext: "出狱后只求一条活路", traits: ["狠", "孤独", "重情"], locationIds: ["songjiang", "jiangzhou"] }),
    character({ id: "feng-yunian", name: "冯玉年", aliases: ["老冯", "冯喷子", "冯署长"], factionIds: ["feng-line"], firstSeen: range(383, 383, "第三八三章"), role: "九区警务署长 · 秦禹的引路人", profile: "二战区冯家子弟，曾是九区主城区警务署长，外号‘冯喷子’：刚正不阿、疾恶如仇，是秦禹起步时的引路人，最终以无名志愿兵身份战死北风口。", story: "冯玉年受家族蒙荫年少居要职，却以刚直敢言、总在会上炮轰不公闻名，因此得了‘冯喷子’的外号。秦禹起步时全靠他帮衬，从只想自保的待规划区青年成长为有责任感的人，正是他一手教出来的。二十余年后，他已是满头白发的老人，而冯系却联合卢家、贺家勾结欧盟攻打北风口、出卖地区利益。他坚决反对，却夹在徒弟秦禹与养育自己的家族之间，拼命周旋仍无力回天。冯系最终被秦禹一方围剿、彻底崩盘，族人死的死、流离的流离。他不怨秦禹，也不依附任何人；北风口被俄六区自由党攻打时，他拿着捡来的步枪当了一名志愿兵，没有官职、没有家族光环，战斗到了最后一刻。死后兜里分文没有，没人认出这个战死的老兵，就是当年风光一时的冯署长。", quote: "我直接跟你说，是在告诉你，我的底线在哪儿。", quoteContext: "对秦禹立下规矩", traits: ["刚正不阿", "疾恶如仇", "重情重义", "悲剧宿命"], locationIds: ["ninth-district", "fengbei", "beifengkou"] }),
    character({ id: "feng-ji", name: "冯济", aliases: [], factionIds: ["feng-line"], firstSeen: range(2070, 2074, "第二零七四章"), role: "后期政治对手", profile: "在后期局势中不断寻找自身处境和利益出口。", story: "冯济是冯系在九区军政中的实际操盘手，精明、强硬，也始终在利益和形势之间摇摆。冯玉年请他照顾秦禹，他不留情面地说战场上怎么照顾，拉上去就得能打，常规对待、不走后门。后期孟玺登门请他出军费，他又模棱两可地说劝一劝老爷子，从不真正把话说死。冯系最终走向勾结外部势力、出卖地区利益的不归路时，冯济也算亲手回答了自己一生的那道选择题。", quote: "战场上怎么照顾？！拉上去就得能打，常规对待，不走后门。", quoteContext: "对子弟兵不徇私", traits: ["精明", "摇摆", "重利益"], locationIds: ["eight-zone", "nanhu"] }),
    character({ id: "xiang-zehao", name: "项择昊", aliases: [], factionIds: ["chuanfu", "gu-line"], firstSeen: range(1560, 1565, "第一五六五章"), role: "川府军事政治人物", profile: "在川府和最终战局中承担重要军事角色。", story: "项择昊是九区党政自卫军的核心人物，外表端正刚毅，心里却揣着一套清醒算盘。他面对欧盟一区代表的压力，拍桌表态九区内政不容任何组织和政党干预，寸步不让。等到军部总政想拉他给顾泰安施压，他也看得清楚，说心眼全让他们长了，别人全是傻子。最终他率自卫军反出党政派系，选择与秦禹和顾系并肩，从川府建制走到耶门落地，是把担当二字活成行动的人。", quote: "九区的内政问题，不容任何组织和政党干预！", quoteContext: "对外部势力的强硬表态", traits: ["坚定", "有担当"], locationIds: ["chuanfu", "red-dan", "yemen"] }),
    character({ id: "meng-xi", name: "孟玺", aliases: [], factionIds: ["chuanfu"], firstSeen: range(1815, 1820, "第一八二零章"), role: "川府谋士", profile: "心黑手狠，善于把复杂局面拆成可执行的狠招。", story: "孟玺原是山头何大江手下的军师，心里那套逻辑清晰得像利刃。劝不动老大时，他会背着老大找何大川，直截了当地说做了他，把隐患处理得干净利落。进入秦禹视野后，他能在川府局势最复杂时列出军费缺口、外部压力和九区烂棋，提出韬光养晦、三年后入关的方案；被秦禹否定后也不恼，转身就能组织舆论战。孟玺的强项，是把复杂局面拆成可执行的狠招。", quote: "他的兵死了，那不是小事儿。听我的，做了他。", quoteContext: "进谏除掉对手", traits: ["狠辣", "聪明", "敢赌"], locationIds: ["chuanfu", "old-triangle", "jiangzhou"] }),
    character({ id: "li-bokang", name: "李伯康", aliases: [], factionIds: ["feng-line", "military-intel"], firstSeen: range(2279, 2284, "第二二八四章"), role: "后期智谋型对手", profile: "幕后操盘能力强，计划细密，能制造持续心理压力。", story: "李伯康被周远征启用时，说的第一句话是我和别人不一样，用我之前，你们最好想好了。傲然却不是虚言，他擅长的不是冲锋陷阵，而是在局势最复杂时精准找到每一处缝隙，让平静棋局变成对手疲于应对的漩涡。后期他与冯济互相利用，让秦禹阵营承受持续心理压力，蓝图与计划层层推进，南沪也在他的运作下从政治角力场变成炮火齐发的战场。他的危险不在武力，而在从容不迫的缜密。", quote: "我和别人不一样，用我之前，你们最好想好了。", quoteContext: "出山前的自负宣言", traits: ["缜密", "阴狠", "擅长心理战"], locationIds: ["nanhu", "old-triangle"] }),
    ...
    character({ id: "ke-hua", name: "柯桦", aliases: [], factionIds: ["military-intel", "eu-zone"], firstSeen: range(2647, 2654, "第二六五四章"), role: "终局外部推手", profile: "在北伐前后提供提点并参与抢人等关键动作。", story: "柯桦是周系在七区的负责人，出场时已处在风声鹤唳的撤离局中，藏在江州外据点两天不敢动，因为他不知道哪个环节出了问题，也不知道计划是否已经暴露。小青龙给他透露重要信息后，两边改换撤离路线，却仍在江州外遭遇巡查小组并爆发枪战，柯桦受伤，被小青龙一路背着救出，因此对他心存感激。此后柯桦与小青龙、小白虎等人秘密进入五区，准备走水路返回夏岛。这个人物的戏份不在台前热血，而在终局外围情报与撤离暗线里，体现大势收束时每个系统都在自保、换线和抢活路。", traits: ["敏锐", "果断"], locationIds: ["bar-city", "eu-first-zone", "xiadao"] }),
    character({ id: "he-dachuan", name: "何大川", aliases: [], factionIds: ["chuanfu"], firstSeen: range(1815, 1820, "第一八二零章"), role: "草莽军事力量", profile: "带有匪气的执行者，能把孟玺的想法落到行动里。", story: "何大川是何大江的亲弟弟，三十岁出头，外表粗犷、脏话连篇，看着没什么素质，孟玺却知道他其实心里很细。他夹在哥哥、山头利益和孟玺的狠招之间，既能问出做掉人至于吗这样的犹疑，也能在发现事情可能牵出川府后，低声劝哥哥不要马虎，必要时找借口把隐患带下山处理掉。这个人粗粝却不蠢，身上有草莽的江湖气，也有对风险的敏感。后来他与孟玺一起进入川府后期棋局，成为谋略之外的执行力量，把许多阴狠判断真正落到行动里。", traits: ["粗粝", "敢打", "执行力强"], locationIds: ["chuanfu", "old-triangle", "zangyuan"] }),
    character({ id: "zhou-xingli", name: "周兴礼", aliases: ["老周"], factionIds: ["feng-line"], firstSeen: range(2700, 2727, "第二七零七章至第二七二七章"), role: "终局高层对手", profile: "后期棋局中以高层政治手段落子的对手。", story: "周兴礼坐在最高军事长官的位置上，武器不是枪，而是任何人都难以轻易动摇的那把椅子。他劝陈仲仁让出盐岛股权，笑着把舰队调动、各方权益和自己的位置都算进同一盘棋里，又感叹最高军事长官不好坐，既要照顾情绪，也要给别人争取权益。他告诫手下枪打出头鸟，太独断就一定会有反制势力，逻辑清晰而冷酷。秦禹终局布局时也不得不演戏忽悠他，可见此人是后期棋局中绕不开的顽石。", quote: "最高军事长官这把椅子不好坐啊，既要照顾你们的情绪，也要多少给其他人争取到一定权益。", quoteContext: "高层的左右权衡", traits: ["老辣", "冷静", "善落子"], locationIds: ["red-dan", "eight-zone"] }),
  ...
  themes: [
    ...
    },
    {
      id: "theme-fate",
      title: "身不由己，却仍要自己扛",
      insight: "很多时候你没得选，但结果还是要你来背。",
      quote: "我是不想玩命，可我有的选择吗？啊，我有吗？",
      quoteContext: "绝境中的反问",
      detail: "这部书里很少有人是‘想’才去拼命的，更多是被处境逼到墙角、退无可退。吴天胤、齐麟、无数底层人都在喊同一句话：我有的选吗？然而小说残酷又诚实地告诉你，哪怕身不由己，最后承担后果的依然是自己。看清这一点，才不至于把所有错都推给时代。",
      anchor: "arc-wu-tianyin"
    },
    {
      id: "theme-principle",
      title: "乱世里，总得有人守着底线",
      insight: "当所有人都谈生存，守原则的人才显得珍贵。",
      quote: "这个年代，讲吃喝的有，讲生存的有，但我还没听到谁讲什么原则呢。",
      quoteContext: "马老爷子的处世观",
      detail: "灾变之后，‘活下去’成了压倒一切的理由，原则、底线、体面都被当成奢侈品。可正是冯玉年这样的人，明知无力回天仍不肯低头，用一杆捡来的步枪守住了自己的底线。小说没有歌颂他们赢了，而是让我们看见：在一个不讲原则的年代里，还有人愿意为原则付账，这件事本身就值得记住。",
      anchor: "arc-black-street"
    }
  ]
};
