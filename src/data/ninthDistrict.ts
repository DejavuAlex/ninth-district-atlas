...
const rawNinthDistrict: Omit<NovelDataset, "locations" | "characters"> & {
  ...
  locations: [
    ...
    { id: "ninth-district", name: "第九特区", kind: "district", x: 78, y: 38, summary: "灾变后重建秩序的区域，也是身份、粮食和权力的入口。", atmosphere: "秩序表面稳定，底层竞争残酷。", factionIds: ["songjiang-police", "wu-line"], eventIds: ["event-qin-enters", "event-public-order"] },
