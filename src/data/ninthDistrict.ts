...
const rawNinthDistrict: Omit<NovelDataset, "locations" | "characters"> & {
  ...
  characters: [
    character({ id: "qin-yu", name: "秦禹", aliases: ["秦老黑", "禹少"], factionIds: ["songjiang-police", "black-street", "chuanfu"], firstSeen: range(1, 2, "序章至第一章"), role: "主角，川府系核心", profile: "从待规划区走出的青年，凭狠劲、判断力和组织能力不断向上。", story: "他先在松江警务和黑街之间求生，随后经营交易线、进入奉北和南沪棋局，最终在川府建立自己的军事政治力量。", quote: "诸位，请保我华夏未来百年无战事！进攻！！", quoteContext: "北伐出关·三十万大军总攻令", traits: ["冷静", "能忍", "重情义", "善于借势"], locationIds: ["planning-zone", "ninth-district", "songjiang", "chuanfu", "nanhu", "bar-city"] }),
    character({ id: "qi-lin", name: "齐麟", aliases: ["麒麟"], factionIds: ["songjiang-police", "chuanfu"], firstSeen: range(1, 37, "序章至第三十六章"), role: "秦禹早期兄弟", profile: "从艰难处境中被逼着成长的伙伴，和秦禹有很深的患难基础。", story: "齐麟早期在松江线中经历失去和转变，之后成为秦禹阵营中值得托付的人。", quote: "我赚钱养活你……你他妈却剥夺了我最后一点尊严……", quoteContext: "被逼到绝境的呐喊", traits: ["忠诚", "坚韧", "敏感"], locationIds: ["songjiang", "ninth-district"] }),
    character({ id: "lao-mao", name: "老猫", aliases: ["猫哥"], factionIds: ["songjiang-police", "black-street"], firstSeen: range(7, 40, "第七章至第四十章"), role: "警务搭档，兄弟线核心", profile: "圆滑、会做人，也能在关键时刻顶上去。", story: "老猫陪秦禹走过松江和黑街早期乱局，用人情和经验弥补秦禹的锋芒。", quote: "咱俩要是普通人也就拉倒了，可身上穿着这身皮，碰见了就不能不管啊。", quoteContext: "对职责的朴素坚持", traits: ["圆滑", "义气", "机敏"], locationIds: ["songjiang", "black-street"] }),
    character({ id: "ma-lao-er", name: "马老二", aliases: ["二哥"], factionIds: ["ma-family", "black-street"], firstSeen: range(75, 76, "第七十五章至第七十六章"), role: "马家年轻一代", profile: "黑街中的奇人，讲面子也敢下狠手。", story: "他和秦禹从互相试探到结盟，帮助秦禹理解并使用地下规则。", quote: "我兜里今天有一百，全花了，明天死了就不亏。", quoteContext: "江湖人的及时行乐", traits: ["豪横", "讲义气", "会办事"], locationIds: ["black-street", "jiangzhou"] }),
    character({ id: "ma-lao-ye", name: "马老爷子", aliases: ["马老"], factionIds: ["ma-family"], firstSeen: range(14, 15, "第十四章"), role: "老江湖", profile: "马家的根基人物，代表旧江湖的经验和分量。", story: "他在早期为马家和秦禹关系提供底色，使黑街线不只是年轻人的斗狠。", quote: "这个年代，讲吃喝的有，讲生存的有，但我还没听到谁讲什么原则呢。", quoteContext: "老江湖的处世观", traits: ["老辣", "稳重"], locationIds: ["black-street"] }),
    character({ id: "yuan-ke", name: "袁克", aliases: [], factionIds: ["yuan-family"], firstSeen: range(40, 41, "第四十章"), role: "前期主要敌手", profile: "依托家族和资源压迫秦禹，是松江早期冲突的核心反派。", story: "袁克多次设局、施压和反扑，最终在待规划区迎来结局。", quote: "咱们一口锅内吃饭，只是角色不同，但本质相同，那就是在这个乱糟糟的环境里，活的稍微好一点。", quoteContext: "反派的生存哲学", traits: ["阴狠", "自负", "资源充足"], locationIds: ["songjiang", "planning-zone"] }),
    ...
    character({ id: "lin-nianlei", name: "林念蕾", aliases: [], factionIds: ["wu-line", "chuanfu"], firstSeen: range(1121, 1205, "第一一二六章至第一二零五章"), role: "秦禹情感线重要人物", profile: "她把秦禹从战争和权谋中拉回私人情感。", story: "林念蕾在中后期与秦禹关系加深，是乱世中少数稳定的情感牵引。", quote: "将军都不能剥夺我的尊严，你们又算个什么东西？！", quoteContext: "柔弱外表下的刚烈", traits: ["清醒", "温柔", "有主见"], locationIds: ["fengbei", "ninth-district"] }),
    character({ id: "wu-di", name: "吴迪", aliases: [], factionIds: ["wu-line"], firstSeen: range(608, 608, "第六零八章"), role: "政治资源入口", profile: "有谋略和现实判断的上层人物。", story: "吴迪多次表态或运作，为秦禹打开更高层级的局面。", quote: "什么叫掀桌子啊？这是自卫反击，是为了和平与自由！", quoteContext: "政客的话术", traits: ["理性", "精明", "懂权衡"], locationIds: ["fengbei", "nanhu"] }),
    character({ id: "gu-yan", name: "顾言", aliases: [], factionIds: ["gu-line"], firstSeen: range(760, 760, "第七六零章"), role: "军政盟友", profile: "名字本身就有分量，背后牵动更大的资源。", story: "顾言在秦禹进入军政层面后成为重要盟友，影响长吉、八区和后期战局。", quote: "没有的话，我来安排，一切消费都算我的！！", quoteContext: "顾家的豪阔做派", traits: ["有背景", "果断", "讲合作"], locationIds: ["changji", "eight-zone", "liu-zone"] }),
    ...
    character({ id: "li-zhan", name: "历战", aliases: [], factionIds: ["chuanfu", "military-intel"], firstSeen: range(555, 555, "第五五五章"), role: "战场尖刀", profile: "能打硬仗、敢接高危任务的军事骨干。", story: "历战从中期行动到最终战场不断承担高风险任务，是秦禹阵营的锋刃。", quote: "呵呵，稳住神。咱和他们也没仇，还给他们送钱，人家没必要犯邪心。", quoteContext: "临战前安抚同伴", traits: ["勇猛", "直接", "抗压"], locationIds: ["seven-zone", "old-triangle", "red-dan", "beifengkou"] }),
    character({ id: "da-ya", name: "大牙", aliases: [], factionIds: ["chuanfu"], firstSeen: range(257, 258, "第二五七章"), role: "军事指挥和骨干", profile: "从早期来电到后期军事才能被运作，是川府战场线重要人物。", story: "大牙在川府扩军和北伐阶段不断被推到前台，承担从战术到指挥的职责。", quote: "我们是锄头，是筐，是采参的棒子，但就不是人，呵呵。", quoteContext: "控诉矿场把人当数字", traits: ["能打", "会带兵", "忠诚"], locationIds: ["chuanfu", "bar-city", "red-dan"] }),
    character({ id: "wu-tianyin", name: "吴天胤", aliases: ["胤哥"], factionIds: ["planned-zone", "black-street"], firstSeen: range(481, 481, "第四八一章"), role: "极端乱世人物", profile: "被时代和亲情逼到极端的人物。", story: "吴天胤的线展示底层人在失去退路后的爆发，也让秦禹重新审视规则。", quote: "我以前是犯了错，可我现在跟普通人一样啊！我需要工作，我得养活自己。", quoteContext: "出狱后只求一条活路", traits: ["狠", "孤独", "重情"], locationIds: ["songjiang", "jiangzhou"] }),
    ...
    character({ id: "feng-ji", name: "冯济", aliases: [], factionIds: ["feng-line"], firstSeen: range(2070, 2074, "第二零七四章"), role: "后期政治对手", profile: "在后期局势中不断寻找自身处境和利益出口。", story: "冯济的选择多次影响八区、九区和最终战局，是秦禹后期必须处理的对手。", quote: "战场上怎么照顾？！拉上去就得能打，常规对待，不走后门。", quoteContext: "对子弟兵不徇私", traits: ["精明", "摇摆", "重利益"], locationIds: ["eight-zone", "nanhu"] }),
    character({ id: "xiang-zehao", name: "项择昊", aliases: [], factionIds: ["chuanfu", "gu-line"], firstSeen: range(1560, 1565, "第一五六五章"), role: "川府军事政治人物", profile: "在川府和最终战局中承担重要军事角色。", story: "项择昊从面见秦禹到最终请战，体现川府系内部的担当和战场选择。", quote: "九区的内政问题，不容任何组织和政党干预！", quoteContext: "对外部势力的强硬表态", traits: ["坚定", "有担当"], locationIds: ["chuanfu", "red-dan", "yemen"] }),
    character({ id: "meng-xi", name: "孟玺", aliases: [], factionIds: ["chuanfu"], firstSeen: range(1815, 1820, "第一八二零章"), role: "川府谋士", profile: "心黑手狠，善于把复杂局面拆成可执行的狠招。", story: "孟玺进入秦禹视野后，多次进谏和布局，帮助川府系在后期战争中占据主动。", quote: "他的兵死了，那不是小事儿。听我的，做了他。", quoteContext: "进谏除掉对手", traits: ["狠辣", "聪明", "敢赌"], locationIds: ["chuanfu", "old-triangle", "jiangzhou"] }),
    character({ id: "li-bokang", name: "李伯康", aliases: [], factionIds: ["feng-line", "military-intel"], firstSeen: range(2279, 2284, "第二二八四章"), role: "后期智谋型对手", profile: "幕后操盘能力强，计划细密，能制造持续心理压力。", story: "李伯康的蓝图、计划和后期疲态构成终局前最强的智谋对抗线。", quote: "我和别人不一样，用我之前，你们最好想好了。", quoteContext: "出山前的自负宣言", traits: ["缜密", "阴狠", "擅长心理战"], locationIds: ["nanhu", "old-triangle"] }),
    ...
    character({ id: "zhou-xingli", name: "周兴礼", aliases: ["老周"], factionIds: ["feng-line"], firstSeen: range(2700, 2727, "第二七零七章至第二七二七章"), role: "终局高层对手", profile: "后期棋局中以高层政治手段落子的对手。", story: "周兴礼在最终阶段以政治手段影响战场，体现乱世高层博弈的冷酷。", quote: "最高军事长官这把椅子不好坐啊，既要照顾你们的情绪，也要多少给其他人争取到一定权益。", quoteContext: "高层的左右权衡", traits: ["老辣", "冷静", "善落子"], locationIds: ["red-dan", "eight-zone"] }),
