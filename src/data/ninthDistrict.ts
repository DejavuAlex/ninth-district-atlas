...
const rawNinthDistrict: Omit<NovelDataset, "locations" | "characters"> & {
  ...
  locations: [
    ...
    { id: "songjiang", name: "松江", kind: "city", x: 72, y: 45, summary: "九区核心城市，秦禹早期扎根之地，警务、黑街与政治利益在此交织。", atmosphere: "城市秩序和地下秩序并行。", sceneImage: "/scenes/songjiang.png", factionIds: ["songjiang-police", "black-street"], eventIds: ["event-police-team", "event-songjiang-return", "event-songjiang-takeover"] },
